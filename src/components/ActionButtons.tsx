...
const ACTIONS: ActionConfig[] = [
  { id: 'feed', icon: '🍙', label: 'FEED', cooldown: 10, color: '#f59e0b' },
  { id: 'play', icon: '🎮', label: 'PLAY', cooldown: 15, color: '#ec4899' },
  { id: 'sleep', icon: '😴', label: 'REST', cooldown: 30, color: '#8b5cf6' },
  { id: 'cuddle', icon: '🫂', label: 'PET', cooldown: 10, color: '#ef4444' },
  { id: 'sing', icon: '🎵', label: 'SING', cooldown: 20, color: '#22c55e' },
];
  ...
  return (
    <div className="flex justify-center gap-2 flex-wrap">
      {ACTIONS.map((action) => {
        ...
        const buttonIcon = isSleeping && action.id === 'sleep' ? '☀️' : action.icon;
